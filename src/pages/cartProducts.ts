            ...
            ${HeaderUser.render()}
                ...
                <section class="max-w-[1240px] m-auto px-[20px] mb-[80px] md:mt-[100px] mt-[80px]">
                    <div class="max-w-[570px] w-full m-auto">
                        ...
                        ${newCart ? newCart.map((newCart: any) => /*html*/`
                            <div
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-red-500 text-[16px] font-bold">${totalProduct?.toLocaleString('vi', { style: 'currency', currency: 'VND' })}</span>
                        </div>
                        <button
