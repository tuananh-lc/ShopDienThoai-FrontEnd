                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        ${users.map((user:any, index) => `
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="py-4 px-6">
                                        <a href="/admin/users/${user._id}/updateuser" data-navigo class="text-[15px] font-medium hover:text-blue-600 dark:text-blue-500 hover:underline">
                                        <i title="edit" class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <button data-id="${user._id}" data-navigo id="btn-remove" class="ml-[10px] text-[15px] font-medium hover:text-blue-600 dark:text-blue-500 hover:underline">
